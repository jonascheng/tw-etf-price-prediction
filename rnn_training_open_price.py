...
dataset_etf_adjusted_history = pd.read_csv('TBrain_Round2_DataSet_20180331/taetfp.csv',encoding='big5-hkscs')
dataset_stock_history = pd.read_csv('TBrain_Round2_DataSet_20180331/tsharep.csv',encoding='big5-hkscs')
dataset_stock_adjusted_history = pd.read_csv('TBrain_Round2_DataSet_20180331/tasharep.csv',encoding='big5-hkscs')
