...
X_train, X_test, y_train, y_test = train_test_split(Xy, test_samples=1, num_forecasts=5)
...
# Visualising the stock price
from util import plot_stock_price
plot_stock_price(supervised2[0].reshape(10, 1), first_ndays=5)
plot_stock_price(X_train[0])

plot_stock_price(supervised2[0].reshape(10, 1), last_ndays=5)
plot_stock_price(y_train[0])

plot_stock_price(supervised2[-1].reshape(10, 1), first_ndays=5)
plot_stock_price(X_test[-1])

plot_stock_price(supervised2[-1].reshape(10, 1), last_ndays=5)
